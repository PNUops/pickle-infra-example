...
# ==========================================================================
# SSH-gateway e2e — run on pve1 as root, AFTER api/console/sshgw deploy and
...
case "$AIP" in 10.100.100.*|172.30.*|"") ko "audit ip is tunnel/gateway not real client ($AIP)";; *) ok "audit ip is a real client IP ($AIP)";; esac
