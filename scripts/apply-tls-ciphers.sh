...
expect_http "pre  pickle :443" 200 --resolve pickle.pusan.ac.kr:443:172.30.1.10 https://pickle.pusan.ac.kr/
...
expect_http "post pickle :443" 200 --resolve pickle.pusan.ac.kr:443:172.30.1.10 https://pickle.pusan.ac.kr/
...
neg=$(curl -skv --tlsv1.2 --tls-max 1.2 -o /dev/null \
        --resolve pickle.pusan.ac.kr:443:172.30.1.10 https://pickle.pusan.ac.kr/ 2>&1 \
