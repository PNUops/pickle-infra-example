...
#   PICKLE_PROXY_IP            172.30.1.10         its address, used by every --resolve
#   PICKLE_HOST_PROBE_IP       172.30.0.1          the Proxmox host on the infra bridge
...
HOST_PROBE_IP="${PICKLE_HOST_PROBE_IP:-172.30.0.1}"  # the Proxmox host on vmbr1: smoke suite + health snapshot
...
PROXY_IP="${PICKLE_PROXY_IP:-172.30.1.10}"
